...
from dentistry.views import IndexView, AboutView, ServiceListView, ServiceCreateView, DoctorsListView, DoctorCreateView, \
    ServiceUpdateView, ServiceDeleteView, DoctorUpdateView, DoctorDeleteView, FeedbackListView, FeedbackDetailView, \
    ContactsView
...
urlpatterns = [
    ...
    path('feedback_detail/<int:pk>', FeedbackDetailView.as_view(), name='feedback_detail'),
